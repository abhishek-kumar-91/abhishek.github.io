...
function BackgroundCircle({}: Props) {
  return (
    ...
    className='relative flex justify-center items-center'>
       <div className='absolute border bg-[#0000005d] border-[#333333] rounded-full h-[200px] w-[200px] mt-52
       animate-ping' 
       />
       <div className=' absolute border bg-[#2b2b2b5d] border-[#333333] rounded-full h-[300px] w-[300px] mt-52
       animate-ping' 
       />
